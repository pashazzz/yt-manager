...
│   │   ├── section.go   # Section {ID, Name, OwnerID, IsDefault, CreatedAt}
│   │   ├── show.go      # Show {ID, Title, PlaylistURL, OwnerID, SectionID, CreatedAt}
...
| Метод | Путь | Описание |
|---|---|---|
| `GET` | `/sections` | Список разделов профиля |
